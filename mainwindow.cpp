...
connect(ui->tableWidget_Item_Data, &QTableWidget::cellDoubleClicked,
    ...
    ui->tableWidget_Item_Data->setRowCount(5);
    for (int i = 0; i < 5; i++){
    ...
    ui->tableWidget_Item_Data->setVisible(false);
}
...
void MainWindow::on_BotsOverview_Button_clicked()
{
    // Toggle visibility
    ui->tableWidget_Item_Data->setVisible(false);
}
...
void MainWindow::on_UserTrades_Button_clicked()
{
    // Toggle visibility
    ui->tableWidget_Item_Data->setVisible(false);
}
